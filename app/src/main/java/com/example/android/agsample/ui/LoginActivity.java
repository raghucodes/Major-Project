...
public class LoginActivity extends AppCompatActivity {
    ...
    private Button mBtnRegister, mBtnLogin, mLearn, mJoin;
    @Override
    ...
    private void findViews() {
        mInputEmail = (EditText) findViewById(R.id.etUserEmail);
        mInputPassword = (EditText) findViewById(R.id.etUserPass);
        mProgressBar = (ProgressBar) findViewById(R.id.progressBar);
        mBtnRegister = (Button) findViewById(R.id.btnUserRegister);
    ...
    private void setOnClickMethods() {
        ...
        mJoin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //startActivity(intent);
                Snackbar.make(view,"login to join us!",Snackbar.LENGTH_LONG).show();
            }
        });
        ...
        mBtnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!android.util.Patterns.EMAIL_ADDRESS.matcher(mInputEmail.getText().toString().trim()).matches()){
